		...
		<div class="pageContent">
			<div class="showMain" id="showMainId">
				...
				<div class="showPost" id="showPostId">
					<img src="../Posters/Cropped/Channel 01.png">
				</div>
			</div>

			<div class="categoryBtn" id="showCategoryBtnid">
				<button id="epi" title="Click to view Episodes" style="background-color: #192837; color: #afbecd;">Episodes</button>
